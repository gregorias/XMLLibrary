...
/**
 * <p>Java class for Indefinite.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="Indefinite">
...
public enum Indefinite {
    ...
    public static Indefinite fromValue(String v) {
        for (Indefinite c: Indefinite.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
